...
def episode_guide_page(showname):
	...
	return render_template("episode_info.html", template_folder="templates", title=random_episode[0], descr=random_episode[1], season=random_episode[2], episode=random_episode[3], airdate=random_episode[4])
